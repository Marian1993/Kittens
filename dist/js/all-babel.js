...
window.Modernizr = function (i, l, a) {
  function t(e) {
    p.cssText = e;
  }
  ...
  function s(e, t) {
    for (var n in e) if (p[e[n]] !== a) return "pfx" != t || e[n];
  ...
  function r(e, t, n) {
    ...
    return c(t, "string") || void 0 === t ? s(o, t) : function (e, t, n) {
      for (var r in e) {
        var o = t[e[r]];
        if (o !== a) return !1 === n ? e[r] : c(o, "function") ? o.bind(n || t) : o;
      }

      return !1;
    }(o = (e + " " + x.join(r + " ") + r).split(" "), t, n);
  }
  ...
  var e,
    ...
    var o,
        ...
        c = l.body,
        s = c || l.createElement("body");
    if (parseInt(n, 10)) for (; n--;) (i = l.createElement("div")).id = r ? r[n] : f + (n + 1), a.appendChild(i);
    return o = ["&#173;", "<style>", e, "</style>"].join(""), a.id = f, s.innerHTML += o, s.appendChild(a), c || d.appendChild(s), e = t(a, e), c ? a.parentNode.removeChild(a) : s.parentNode.removeChild(s), !!e;
  },
      N = (o = {
    select: "input",
    change: "input",
    ...
    t = t || l.createElement(o[e] || "div");
    var n = ((e = "on" + e) in t);
    return n || (t = !t.setAttribute ? l.createElement("div") : t).setAttribute && t.removeAttribute && (t.setAttribute(e, ""), n = c(t[e], "function"), void 0 === t[e] || (t[e] = a), t.removeAttribute(e)), t = null, n;
  }),
      M = {}.hasOwnProperty,
      P = void 0 !== M && void 0 !== M.call ? function (e, t) {
    return M.call(e, t);
  } : function (e, t) {
  ...
  Function.prototype.bind || (Function.prototype.bind = function (n) {
    ...
    var o = T.call(arguments, 1),
      ...
      if (this instanceof i) {
        ...
        var t = new e(),
            e = r.apply(t, o.concat(T.call(arguments)));
        return Object(e) === e ? e : t;
      }

      return r.apply(n, o.concat(T.call(arguments)));
    };

    return i;
  });
  var A, L, $;
  A = ["fontface", "touch", "csstransforms3d", "generatedcontent"], y = ['@font-face {font-family:"font";src:url("https://")}', ["@media (", v.join("touch-enabled),("), f, ")", "{#touch{top:9px;position:absolute}}"].join(""), ["@media (", v.join("transform-3d),("), f, ")", "{#csstransforms3d{left:9px;position:absolute;height:3px;}}"].join(""), ['#generatedcontent:after{content:"', h, '";visibility:hidden}'].join("")].join(""), j(y, function (e, t) {
    for (var n = l.styleSheets[l.styleSheets.length - 1], n = n ? n.cssRules && n.cssRules[0] ? n.cssRules[0].cssText : n.cssText || "" : "", r = e.childNodes, o = {}; L--;) o[r[L].id] = r[L];

    u.touch = "ontouchstart" in i || i.DocumentTouch && l instanceof DocumentTouch || 9 === (o.touch && o.touch.offsetTop), u.csstransforms3d = 9 === (o.csstransforms3d && o.csstransforms3d.offsetLeft) && 3 === o.csstransforms3d.offsetHeight, u.generatedcontent = 1 <= (o.generatedcontent && o.generatedcontent.offsetHeight), u.fontface = /src/i.test(n) && 0 === n.indexOf(t.split(" ")[0]);
  }, L = A.length, A);

  for ($ in E.flexbox = function () {
    return r("flexOrder");
  }, E.canvas = function () {
    var e = l.createElement("canvas");
    return !!e.getContext && !!e.getContext("2d");
  }, E.canvastext = function () {
    return !!u.canvas && !!c(l.createElement("canvas").getContext("2d").fillText, "function");
  }, E.webgl = function () {
    try {
      var e = l.createElement("canvas"),
          t = !(!i.WebGLRenderingContext || !e.getContext("experimental-webgl") && !e.getContext("webgl")),
          e = a;
    } catch (e) {
      t = !1;
    }
    ...
    return !!r("indexedDB", i);
  }, E.hashchange = function () {
    return N("hashchange", i) && (l.documentMode === a || 7 < l.documentMode);
  }, E.history = function () {
    ...
    for (var e = -1, t = b.length; ++e < t;) if (i[b[e] + "WebSocket"]) return !0;

    return "WebSocket" in i;
  }, E.rgba = function () {
    return t("background-color:rgba(150,255,150,.5)"), n(p.backgroundColor, "rgba");
  }, E.hsla = function () {
    return t("background-color:hsla(120,40%,100%,.5)"), n(p.backgroundColor, "rgba") || n(p.backgroundColor, "hsla");
  }, E.multiplebgs = function () {
    return t("background:url(https://),url(https://),red url(https://)"), /(url\s*\(.*?){3}/.test(p.background);
    ...
    return "" === l.createElement("div").style.textShadow;
  }, E.opacity = function () {
    return t(v.join("opacity:.55;") + ""), /^0.55$/.test(p.opacity);
    ...
    return t((e + "-webkit- ".split(" ").join("gradient(linear,left top,right bottom,from(#9f9),to(white));" + e) + v.join("linear-gradient(left top,#9f9, white);" + e)).slice(0, -e.length)), n(p.backgroundImage, "gradient");
    ...
    var e = !!r("perspective");
    return e = e && "webkitPerspective" in d.style ? u.csstransforms3d : e;
    ...
    return !!l.createElementNS && !!l.createElementNS(C, "svg").createSVGRect;
  }, E.inlinesvg = function () {
    var e = l.createElement("div");
    return e.innerHTML = "<svg/>", (e.firstChild && e.firstChild.namespaceURI) == C;
  }, E.smil = function () {
    return !!l.createElementNS && /SVGAnimate/.test(g.call(l.createElementNS(C, "animate")));
  }, E.svgclippaths = function () {
    return !!l.createElementNS && /SVGClipPath/.test(g.call(l.createElementNS(C, "clipPath")));
  }, E) P(E, $) && (e = $.toLowerCase(), u[e] = E[$](), k.push((u[e] ? "" : "no-") + e));

  return u.input || (u.input = function (e) {
    for (var t = 0, n = e.length; t < n; t++) w[e[t]] = e[t] in m;

    return w.list && (w.list = !!l.createElement("datalist") && !!i.HTMLDataListElement), w;
    ...
    if ("object" == typeof e) for (var n in e) P(e, n) && u.addTest(n, e[n]);else {
      if (e = e.toLowerCase(), u[e] !== a) return u;
      t = "function" == typeof t ? t() : t, d.className += " " + (t ? "" : "no-") + e, u[e] = t;
    }
    return u;
  }, t(""), m = null, function (e, t) {
    function l(e) {
      for (var t, n, r = {}, o = e.createElement, i = e.createDocumentFragment, a = "string" == typeof (n = p.elements) ? n.split(" ") : n, c = i(), s = a.length; s--;) t = a[s], r[t] = o(t), c.createElement(t);

      e.createElement = function (e) {
        var t = (r[e] || (r[e] = o(e))).cloneNode(!1);
        return p.shivMethods && !f.test(e) ? c.appendChild(t) : t;
      }, e.createDocumentFragment = function () {
        var e = c.cloneNode(!1);
        return p.shivMethods && l(e), e;
      };
    }

    function n(e) {
      var t, n, r;
      return e.documentShived || (p.shivCSS && !o && (n = "article,aside,details,figcaption,figure,footer,header,hgroup,nav,section{display:block}audio{display:none}canvas,video{display:inline-block;*display:inline;*zoom:1}[hidden]{display:none}audio[controls]{display:inline-block;*display:inline;*zoom:1}mark{background:#FF0;color:#000}", r = (t = e).createElement("p"), t = t.getElementsByTagName("head")[0] || t.documentElement, r.innerHTML = "x<style>" + n + "</style>", t = !!t.insertBefore(r.lastChild, t.firstChild)), (t = p.shivMethods && !i ? !l(e) : t) && (e.documentShived = t)), e;
    }
    ...
    var o,
        ...
        u,
        d = e.html5 || {},
        f = /^<|^(?:button|iframe|input|script|textarea)$/i;
    a = t.createElement("a"), c = e.getComputedStyle, s = t.documentElement, (u = t.body || (r = s.insertBefore(t.createElement("body"), s.firstChild))).insertBefore(a, u.firstChild), a.hidden = !0, a.innerHTML = "<xyz></xyz>", o = "none" == (a.currentStyle || c(a, null)).display, i = 1 == a.childNodes.length || function () {
      try {
        t.createElement("a");
      } catch (e) {
        return !0;
    ...
    }(), u.removeChild(a), r && s.removeChild(r);
    var p = {
      elements: d.elements || "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video".split(" "),
      shivCSS: !1 !== d.shivCSS,
    ...
    e.html5 = p, n(t);
  }(this, l), u._version = "2.5.2", u._prefixes = v, u._domPrefixes = x, u._cssomPrefixes = b, u.mq = function (e) {
    var t,
        n = i.matchMedia || i.msMatchMedia;
    return n ? n(e).matches : (j("@media " + e + " { #" + f + " { position: absolute; } }", function (e) {
      t = "absolute" == (i.getComputedStyle ? getComputedStyle(e, null) : e.currentStyle).position;
    }), t);
  }, u.hasEvent = N, u.testProp = function (e) {
    return s([e]);
  }, u.testAllProps = r, u.testStyles = j, u.prefixed = function (e, t, n) {
    return t ? r(e, t, n) : r(e, "pfx");
  }, d.className = d.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (" js " + k.join(" ")), u;
  ...
  function g() {
    var e = b.shift();
    x = 1, e ? e.t ? v(function () {
      ("c" == e.t ? T.injectCss : T.injectJs)(e.s, 0, e.a, e.x, e.e, 1);
    }, 0) : (e(), g()) : x = 0;
  }

  function t(e, t, n, r, o) {
    return x = 0, t = t || "j", m(e) ? (a = "c" == t ? w : S, c = e, s = t, t = this.i++, o = (o = o) || T.errorTimeout, l = {}, d = u = 0, f = {
      t: s,
      s: c,
      e: n,
      a: r,
      x: o
    }, 1 === k[c] && (d = 1, k[c] = [], l = p.createElement(a)), "object" == a ? l.data = c : (l.src = c, l.type = a), l.width = l.height = "0", l.onerror = l.onload = l.onreadystatechange = function () {
      i.call(this, d);
    }, b.splice(t, 0, f), "img" != a && (d || 2 === k[c] ? (E.insertBefore(l, C ? null : y), v(i, o)) : k[c].push(l))) : (b.splice(this.i++, 0, e), 1 == b.length && g()), this;

    function i(e) {
      if (!u && h(l.readyState) && (f.r = u = 1, x || g(), l.onload = l.onreadystatechange = null, e)) for (var t in "img" != a && v(function () {
        E.removeChild(l);
      }, 50), k[c]) k[c].hasOwnProperty(t) && k[c][t].onload();
    }
  ...
  var n,
      r = p.documentElement,
      v = e.setTimeout,
      y = p.getElementsByTagName("script")[0],
      o = {}.toString,
      b = [],
      x = 0,
      i = ("MozAppearance" in r.style),
      C = i && !!p.createRange().compareNode,
      E = C ? r : y.parentNode,
      r = !!p.attachEvent,
      S = i ? "object" : r ? "script" : "img",
      w = r ? "script" : S,
    ...
    function u(e, t, n, r, o) {
      var i = function (e) {
        for (var t, n, e = e.split("!"), r = s.length, o = e.pop(), i = e.length, o = {
          ...
          origUrl: o,
          prefixes: e
        }, a = 0; a < i; a++) n = e[a].split("="), (t = l[n.shift()]) && (o = t(o, n));
      ...
      i.url.split(".").pop().split("?").shift(), i.bypass || (t = t && (d(t) ? t : t[e] || t[r] || t[e.split("/").pop().split("?")[0]] || g), i.instead ? i.instead(e, t, n, r, o) : (k[i.url] ? i.noexec = !0 : k[i.url] = 1, n.load(i.url, i.forceCSS || !i.forceJS && "css" == i.url.split(".").pop().split("?").shift() ? "c" : void 0, i.noexec, i.attrs, i.timeout), (d(t) || d(a)) && n.load(function () {
    ...
    function t(e, t) {
      function n(n, e) {
        if (n) {
          if (m(n)) u(n, c = !e ? function () {
            var e = [].slice.call(arguments);
            s.apply(this, e), l();
          } : c, t, 0, i);else if (Object(n) === n) for (o in r = function () {
            var e,
                t = 0;
    ...
    if (m(e)) u(e, 0, o, 0);else if (a(e)) for (n = 0; n < e.length; n++) m(r = e[n]) ? u(r, 0, o, 0) : a(r) ? T(r) : Object(r) === r && t(r, o);else Object(e) === e && t(e, o);
  };
  ...
  T.addPrefix = function (e, t) {
  ...
  }, 0)), e.yepnope = c(), e.yepnope.executeStack = g, e.yepnope.injectJs = function (e, t, n, r, o, i) {
    var a,
        c,
    ...
    t = i ? g : t || f, s.onreadystatechange = s.onload = function () {
      !a && h(s.readyState) && (a = 1, t(), s.onload = s.onreadystatechange = null);
    }, v(function () {
      a || t(a = 1);
    }, r), o ? s.onload() : y.parentNode.insertBefore(s, y);
